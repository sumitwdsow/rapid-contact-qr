  ...
  return (
    <section className="py-16 md:py-20">
      <div className="container">
        <motion.div
          className="relative overflow-hidden rounded-[2rem] bg-gradient-primary p-8 md:p-16"
        ...
        >
          ...
          <div className="relative flex flex-col items-center text-center">
            {/* Badge */}
            <motion.div
              className="mb-6 inline-flex items-center gap-2 rounded-full bg-white/20 px-4 py-1.5 text-sm font-bold text-primary-foreground backdrop-blur-sm"
            ...
            {/* Headline */}
            <motion.h2
              className="mb-5 text-3xl font-extrabold text-primary-foreground sm:text-4xl md:text-5xl"
            ...
            {/* Subheadline */}
            <motion.p
              className="mb-8 max-w-xl text-base text-primary-foreground/85 md:text-lg"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              <Link to="/order">
                <Button
                  size="lg"
                  className="h-13 gap-2 bg-white px-8 text-base font-bold text-primary hover:bg-white/90"
                >
                  Order Your QR Tag
